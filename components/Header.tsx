        ...
        <div className="container mx-auto px-4 flex items-center justify-between gap-6">
          ...
          <form onSubmit={handleSearch} className="flex-1 max-w-xl relative hidden md:block">
            <input 
              ...
              className="w-full bg-white text-black h-11 pl-4 pr-12 rounded-sm outline-none focus:ring-0 placeholder:text-gray-500 font-medium"
            />
            <button type="submit" className="absolute right-0 top-0 h-11 w-11 bg-[#333] flex items-center justify-center text-white hover:bg-black transition-colors">
              <Search size={20} />
            </button>
          </form>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-10">
                        ...
                        <div key={cat.slug} className="group">
                            <Link 
                                ...
                                className="text-white font-bold uppercase tracking-wider mb-4 block hover:text-blue-400 flex items-center justify-between border-b border-transparent group-hover:border-blue-400 pb-1 w-fit transition-all"
