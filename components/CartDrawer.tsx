    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
        ...
        <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50">
          <h2 className="text-xl font-bold">Кошик ({items.length})</h2>
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                       ...
                       <button onClick={() => removeItem(item.id)} className="text-xs text-red-500 hover:text-red-700 underline mt-1">Видалити</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {items.length > 0 && (
          <div className="p-6 border-t border-gray-100 bg-gray-50">
            ...
            <Link href="/checkout" onClick={toggleCart} className="block w-full bg-[#222] text-white text-center font-bold py-4 rounded-xl hover:bg-black transition-colors">
               Оформити замовлення
            </Link>
          </div>
        )}
