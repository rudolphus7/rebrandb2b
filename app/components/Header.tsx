...
export default function Header({ onCartClick, cartCount, onLogout, onMobileMenuClick }: HeaderProps) {
    ...
    <header className="sticky top-0 z-50 bg-[#111111] border-b border-white/10 shadow-xl">
        ...
        <AnimatePresence>
          {isCatalogOpen && (
            ...
            >
              <div className="max-w-[1600px] mx-auto flex max-h-[85vh]"> {/* Обмеження висоти */}
                ...
                <div className="flex-1 p-6 overflow-y-auto custom-scrollbar overscroll-contain"> {/* overscroll-contain блокує прокрутку боді */}
