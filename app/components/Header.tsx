...
// --- КОНФІГУРАЦІЯ МЕНЮ (Чітко за твоїм списком) ---
const MENU_STRUCTURE = [
  {
    id: 'bags',
    label: 'Сумки',
    items: [
      { name: 'Валізи', dbValue: 'Валізи' },
      { name: 'Косметички', dbValue: 'Косметички' },
      { name: 'Мішок спортивний', dbValue: 'Мішок спортивний' },
      { name: 'Рюкзаки', dbValue: 'Рюкзаки' },
      { name: 'Сумки для ноутбуків', dbValue: 'Сумки для ноутбуків' },
      { name: 'Сумки для покупок', dbValue: 'Сумки для покупок' },
      { name: 'Сумки дорожні та спортивні', dbValue: 'Сумки дорожні та спортивні' },
      { name: 'Сумки на пояс', dbValue: 'Сумки на пояс' },
      { name: 'Термосумки', dbValue: 'Термосумки' },
    ]
  },
  {
    id: 'pens',
    label: 'Ручки',
    items: [
      { name: 'Еко ручки', dbValue: 'Еко ручки' },
      { name: 'Металеві ручки', dbValue: 'Металеві ручки' },
      { name: 'Олівці', dbValue: 'Олівці' },
      { name: 'Пластикові ручки', dbValue: 'Пластикові ручки' },
    ]
  },
  {
    id: 'travel',
    label: 'Подорож та відпочинок',
    items: [
      { name: 'Все для пікніка', dbValue: 'Все для пікніка' },
      { name: 'Ліхтарики', dbValue: 'Ліхтарики' },
      { name: 'Ланч бокси', dbValue: 'Ланч бокси' },
      { name: 'Лопати', dbValue: 'Лопати' },
      { name: 'Пледи', dbValue: 'Пледи' },
      { name: 'Пляшки для пиття', dbValue: 'Пляшки для пиття' },
      { name: 'Подушки', dbValue: 'Подушки' },
      { name: 'Термоси та термокружки', dbValue: 'Термоси та термокружки' },
      { name: 'Фляги', dbValue: 'Фляги' },
      { name: 'Фрізбі', dbValue: 'Фрізбі' },
      { name: 'Штопори', dbValue: 'Штопори' },
    ]
  },
  {
    id: 'umbrellas',
    label: 'Парасолі',
    items: [
      { name: 'Парасолі складні', dbValue: 'Парасолі складні' },
      { name: 'Парасолі-тростини', dbValue: 'Парасолі-тростини' },
    ]
  },
  {
    id: 'clothes',
    label: 'Одяг',
    items: [
      { name: 'Вітровки', dbValue: 'Вітровки' },
      { name: 'Рукавички', dbValue: 'Рукавички' },
      { name: 'Спортивний одяг', dbValue: 'Спортивний одяг' },
      { name: 'Футболки', dbValue: 'Футболки' },
      { name: 'Поло', dbValue: 'Поло' },
      { name: 'Дитячий одяг', dbValue: 'Дитячий одяг' },
      { name: 'Реглани, фліси', dbValue: 'Реглани, фліси' },
      { name: 'Жилети', dbValue: 'Жилети' },
      { name: 'Куртки та софтшели', dbValue: 'Куртки та софтшели' },
    ]
  },
  {
    id: 'headwear',
    label: 'Головні убори',
    items: [
      { name: 'Дитяча кепка', dbValue: 'Дитяча кепка' },
      { name: 'Панами', dbValue: 'Панами' },
      { name: 'Шапки', dbValue: 'Шапки' },
      { name: 'Кепки', dbValue: 'Кепки' },
    ]
  },
  {
    id: 'tools',
    label: 'Інструменти',
    items: [
      { name: 'Викрутки', dbValue: 'Викрутки' },
      { name: 'Мультитули', dbValue: 'Мультитули' },
      { name: 'Набір інструментів', dbValue: 'Набір інструментів' },
      { name: 'Ножі', dbValue: 'Ножі' },
      { name: 'Рулетки', dbValue: 'Рулетки' },
    ]
  },
  {
    id: 'office',
    label: 'Офіс',
    items: [
      { name: 'Записні книжки', dbValue: 'Записні книжки' },
      { name: 'Календарі', dbValue: 'Календарі' },
    ]
  },
  {
    id: 'accessories',
    label: 'Персональні аксессуари',
    items: [
      { name: 'Брелки', dbValue: 'Брелки' },
      { name: 'Візитниці', dbValue: 'Візитниці' },
      { name: 'Дзеркала', dbValue: 'Дзеркала' },
    ]
  },
  {
    id: 'prof',
    label: 'Для професіоналів',
    items: [
      { name: 'Опадоміри', dbValue: 'Опадоміри' },
    ]
  },
  {
    id: 'electronics',
    label: 'Електроніка',
    items: [
      { name: 'Аксесуари', dbValue: 'Аксесуари' },
      { name: 'Годинники', dbValue: 'Годинники' },
      { name: 'Зарядні пристрої', dbValue: 'Зарядні пристрої' },
      { name: 'Зволожувачі повітря', dbValue: 'Зволожувачі повітря' },
      { name: 'Лампи', dbValue: 'Лампи' },
      { name: 'Портативна акустика', dbValue: 'Портативна акустика' },
    ]
  },
  {
    id: 'home',
    label: 'Дім',
    items: [
      { name: 'Дошки кухонні', dbValue: 'Дошки кухонні' },
      { name: 'Кухонне приладдя', dbValue: 'Кухонне приладдя' },
      { name: 'Млини для спецій', dbValue: 'Млини для спецій' },
      { name: 'Набори для сиру', dbValue: 'Набори для сиру' },
      { name: 'Рушники', dbValue: 'Рушники' },
      { name: 'Свічки', dbValue: 'Свічки' },
      { name: 'Сковорідки', dbValue: 'Сковорідки' },
      { name: 'Стакани', dbValue: 'Стакани' },
      { name: 'Чайники', dbValue: 'Чайники' },
      { name: 'Годівнички', dbValue: 'Годівнички' },
    ]
  },
  {
    id: 'dishes',
    label: 'Посуд',
    items: [
      { name: 'Горнятка', dbValue: 'Горнятка' },
    ]
  },
  {
    id: 'packaging',
    label: 'Упаковка',
    items: [
      { name: 'Подарункова коробка', dbValue: 'Подарункова коробка' },
      { name: 'Подарунковий пакет', dbValue: 'Подарунковий пакет' },
    ]
  },
];
