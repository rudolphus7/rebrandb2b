...
import { 
  ...
  FileText, Phone, Calendar, ShieldAlert, Lock 
} from "lucide-react";
import { format } from "date-fns";
import { uk } from "date-fns/locale";

// --- ВАЖЛИВО: Впишіть сюди свій email ---
// Це додатковий захист інтерфейсу: кнопки будуть активні тільки для вас
const ADMIN_EMAIL = "vlad@gmail.com"; 
    ...
    <div>
      ...
      <div className="bg-[#1a1a1a] p-4 rounded-2xl border border-white/5 mb-6">
         <div className="relative max-w-md">
            <input 
                type="text" 
                placeholder="Пошук за Компанією, ЄДРПОУ або Телефоном..." 
